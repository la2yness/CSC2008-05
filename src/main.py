...
def main():
    ...
    wishlist = [
        0,   # 정문
        121, # 우주전투기 (min_height: 110)
        122, # 비룡열차 (min_height: 110)
        155, # 레니의 마법학교 (min_height: 110)
        60,  # 챔피온쉽로데오 (min_height: 130)
        196, # 레일 슬라이드 (min_height: 130)
        190, # 레이싱 코스 (min_height: 120)
        102, # 불 하우스 (min_height: 125)
        195, # 호러메이즈
        180, # 차이나문 (식당)
        217, # 판타스틱 윙스 (공연)
        59,  # 게임 어드벤처
